...
output.dir = "./results/Pfam_less_H_sapiens/" #output directory for results

dataset.info = "./data_folder/metadata/Pfam_metadata_less_H_sapiens.txt" #genome metadata file it should contain at least for each genome: 1) path for annotation data; 2) phenotype data (numeric); 3) normalization data (numeric)

x.column = 2 #which column contains phenotype data?

ontology = "other" #which dictionary data type?

dict.path = "./data_folder/dics/Pfam_less_H_sapiens.dic" #file for dictionary file (two-column file containing annotation IDs and their descriptions not needed for GO
