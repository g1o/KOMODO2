...
dataset.info = "./data_folder/metadata/GO_metadata_Pan_proxy.txt" #genome metadata file it should contain at least for each genome: 1) path for annotation data; 2) phenotype data (numeric); 3) normalization data (numeric)
