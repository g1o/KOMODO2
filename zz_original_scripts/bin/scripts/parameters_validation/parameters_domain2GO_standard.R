...
KOMODO2 <- list(annotation_files_dir = "../../data/domain2GO/", #Directory where annotation files are located. If not provided, file described in variable "dataset.info" should contain absolute paths to annotation files
                ...
                dataset.info = "../../data/metadata/GO_metadata_standard.txt", #genome metadata file, it should contain at least, for each genome: 1) path for annotation data; 2) phenotype data (numeric); 3) normalization data (numeric)
