...
KOMODO2 <- list(output.dir = "/Users/chico/projects/KOMODO2/development/KOMODO2/results/EUK/Pfam/", #output directory for results

                dataset.info = "/Users/chico/projects/KOMODO2/development/KOMODO2/data/validation/EUK/metadata/Pfam_metadata_KOMODO2.txt", #genome metadata file, it should contain, at least, and for each genome: 1) path for annotation data (first column); 2) phenotype data (numeric); 3) normalization data (numeric)

                x.column = 2, #which column contains phenotype data? (numeric)

                ontology = "other", #which dictionary data type? (possible values are "GO" and "other")

                dict.path = "/Users/chico/projects/KOMODO2/development/KOMODO2/data/validation/EUK/dic/Pfam.dic", #file for dictionary file (two-column file containing annotation IDs and their descriptions, not needed for GO
