...
annotation.files.dir = "./data_folder/Pfam/" #Directory where annotation files are located. If not provided file described in variable "dataset.info" should contain absolute paths to annotation files

output.dir = "./results/Pfam_Pan_proxy/" #output directory for results
...
dict.path = "./data_folder/dics/Pfam.dic" #file for dictionary file (two-column file containing annotation IDs and their descriptions not needed for GO
...
tree_path = "./data_folder/trees/tree_genome_IDs.nwk" #path for tree file

tree_type = "newick" #tree file type (either "nexus" or "newick" case-sensitive)

# cores = 4 #how many cores to use?

linear_model_cutoff = 0.5 # basically to tell KOMODO2 how much graphical output it should produce. We configure it to generate plots only for annotation terms with corrected q-values for phylogenetically independent contrasts smaller than 0.5.
